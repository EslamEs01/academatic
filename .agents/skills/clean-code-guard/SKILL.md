...
Inspect the changed implementation and its callers for scope expansion, privacy or
role-boundary regressions, and divergence from the active SpecKit contracts. This
is a quality and scope review only: it supplements, and never replaces,
correctness, security/privacy, accessibility, visual, or mutation review.
