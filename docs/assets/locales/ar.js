...
export default {
  ...
  menu: {
    ...
    logoutConfirm: { title: 'تسجيل الخروج؟', msg: 'سيتم إنهاء جلستك التجريبية. لا يتم حفظ أي بيانات حقيقية.', cta: 'تسجيل الخروج', toast: 'سيتوفّر تسجيل الخروج بعد ربط الخادم.' },
  },
  ...
  gallery: {
    ...
    demoToast: 'إشعار تجريبي لعرض المكوّن فقط.',
    showToast: 'عرض تنبيه',
  },
